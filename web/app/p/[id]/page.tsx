    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/" className="px-4 py-2 bg-indigo-600 text-foreground rounded-lg hover:bg-indigo-700 transition-colors">
            Go to OpenCode HCI
          </Link>
        </div>
      </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <Link href="/" className="flex items-center gap-2 text-indigo-400 hover:text-indigo-300 transition-colors">
                <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-foreground font-bold text-xs">
                  OC
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="mt-6 bg-[#1a1a1f] border border-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-foreground">{project.files.length}</span>
                </div>
                <div className="flex justify-between">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#1a1a1f] border border-gray-800 rounded-lg overflow-hidden">
              ...
              <div className="p-0">
                <pre className="text-sm text-gray-300 overflow-auto p-4 bg-background max-h-[600px]">
            ...
            <div className="mt-6 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-lg p-6 text-center">
              <h3 className="text-lg font-semibold text-foreground mb-2">Want to build something like this?</h3>
              <p className="text-gray-300 mb-4">
                OpenCode HCI is the first AI coding agent designed around humans, not just code.
              </p>
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-foreground rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all"
              >
                <span>🚀</span>
                Try OpenCode HCI
              </Link>
